        ...
        <div className="row align-items-center justify-content-between ">
          ...
          <div className="col-xl-4 col-lg-6 wow fadeInRightBig">
            <div className="exchange">
              ...
              <div className="exchange-box">
                ...
                <div>
                  <div className="form-froup">
                    ...
                    <input type="number"  placeholder={token_1?.symbol || "select"}
              ...
              <a className="rotate">
                <img src="../public/assets/img/exchange-img.png" alt="" onClick={() => reset(token_1,token_2,inputAmount)} />
              </a>
              <div className="exchange-box">
                <div className="selector">
                ...
                <div>
                  <div className="form-froup">
                    <span onClick={() => setOpenToken(true)}>Open</span>
                    <input type="number" placeholder={token_2?.symbol || "select"}
                      className="form-control"  onChange={(e) => setInputAmount(e.target.value)}
             ...
             <a onClick={()=>swap(token_2.address,inputAmount)} className="button-1">Exchange</a>
            </div>
          </div>
        </div>
      </div>
